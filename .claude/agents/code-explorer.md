---
name: code-explorer
description: 深度分析现有代码库特性，追踪执行路径、映射架构层次、理解模式和抽象。在功能开发 Phase 2 探索阶段和代码导航时调用。
...
- Supabase client（server vs browser）选择是否正确
- FastAPI 路由是否有认证注入
- LaTeX 渲染错误处理
- n8n workflow 触发点
