...
完整定义见：`.cursor/rules/`、`.cursor/skills/README.md`、`.cursor/agents/README.md`、`.cursor/commands/`。根目录 **`.cursorrules`** 为摘要与指针；**核心规则**（alwaysApply）：task-priority-workflow、agent-orchestration、project-structure、post-task-workflow 等。
