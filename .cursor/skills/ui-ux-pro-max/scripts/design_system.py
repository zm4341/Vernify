...
def persist_design_system(design_system: dict, page: str = None, output_dir: str = None, page_query: str = None) -> dict:
    ...
    # Use project name for project-specific folder; Vernify outputs to docs/design-system/
...
def format_master_md(design_system: dict) -> str:
    ...
    lines.append("")
    project_slug = design_system.get("project_name", "PROJECT").lower().replace(' ', '-')
    lines.append(f"> **LOGIC:** When building a specific page, first check `docs/design-system/{project_slug}/pages/[page-name].md`.")
    lines.append(f"> If that file exists, its rules **override** this Master file (`docs/design-system/{project_slug}/MASTER.md`).")
...
def format_page_override_md(design_system: dict, page_name: str, page_query: str = None) -> str:
    ...
    lines.append("")
    project_slug = design_system.get("project_name", "PROJECT").lower().replace(' ', '-')
    lines.append(f"> ⚠️ **IMPORTANT:** Rules in this file **override** the Master file (`docs/design-system/{project_slug}/MASTER.md`).")
