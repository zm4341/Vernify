...
**开发流程**：任务开始/结束的完整步骤（Graphiti 检索、GitNexus、issue+分支、detect_changes → commit → Graphiti 记录 → 文档 → PR）以 `task-priority-workflow.mdc` 与 `docs/CLAUDE-CURSOR-COLLABORATION.md` 为准。
